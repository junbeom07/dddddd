...
while True:
    ...
    for face in faces2:
        ...
        landmarks_points2 = []  # 여기를 추가하여 초기화합니다.
        for n in range(0, 68):
            x = landmarks.part(n).x
            y = landmarks.part(n).y
    ...
    for triangle_index in indexes_triangles:
        ...
        if warped_triangle.shape[:2] != mask_triangles_designed.shape[:2]:
            print("Size mismatch between warped_triangle and mask_triangles_designed")
            # 여기서 크기를 맞추는 코드를 추가할 수 있습니다.
            # 예를 들어, warped_triangle의 크기에 맞게 mask를 리사이즈할 수 있습니다.
